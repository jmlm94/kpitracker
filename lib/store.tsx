    ...
    return {
      ...
      upsertSubmission: (sub) =>
        setState((s) => {
          ...
          // Write submitted values into progress so the dashboard / KPI cards
          // reflect the numbers immediately. We always write (even for past
          // months) because progress is the "latest known" snapshot used by
          // the dashboard. Historical per-month data lives in submissions[].
